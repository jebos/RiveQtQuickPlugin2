...
namespace rive::gpu
{
static void maybe_invalidate_framebuffer(GLenum target,
    ...
    const uint8_t imageDataRGBAPremul[])
{
    ...
    glutils::SetTexture2DSamplingParams(
        mipLevelCount > 1 ? GL_LINEAR_MIPMAP_LINEAR : GL_LINEAR,
        GL_LINEAR);
...
void RenderContextGLImpl::flush(const FlushDescriptor& desc)
{
    ...
    if (desc.gradSpanCount > 0)
    {
        ...
        maybe_invalidate_framebuffer(GL_FRAMEBUFFER, 1, &colorAttachment0);
    ...
    else
    {
        ...
        maybe_invalidate_framebuffer(GL_FRAMEBUFFER,
    ...
    else
    {
            ...
            RenderTargetGL::MSAAResolveAction::framebufferBlit)
        {
            ...
            maybe_invalidate_framebuffer(GL_READ_FRAMEBUFFER,
                                         1,
